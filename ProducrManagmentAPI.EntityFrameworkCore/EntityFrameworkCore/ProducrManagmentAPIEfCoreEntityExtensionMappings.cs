...
public static class ProducrManagmentAPIEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE ProducrManagmentAPIModuleExtensionConfigurator CLASS (in the Domain.Shared project)
