...
namespace ProducrManagmentAPI.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("ProducrManagmentAPI") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "ProducrManagmentAPI", DisplayName = "ProducrManagmentAPI API", Resources = { "ProducrManagmentAPI" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["ProducrManagmentAPI_Swagger:ClientId"];
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            var swaggerRootUrl = configurationSection["ProducrManagmentAPI_Swagger:RootUrl"]?.TrimEnd('/');
